...
export class SceneRenderer {
    ...
    constructor(regl, resource_manager) {
        ...
        this.create_texture_and_buffer("base_with_shadows", {}); 
    ...
    render(scene_state) {
        ...
        this.render_in_texture("base_with_shadows", () => {

            this.map_mixer.render(scene_state ,this.texture("shadows"), this.texture("base"));
        })

        this.fog_mixer.render(scene_state, this.texture("distances"), this.texture("base_with_shadows"));
    }
}
